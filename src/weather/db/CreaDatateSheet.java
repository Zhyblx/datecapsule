...
public class CreaDatateSheet {
    ...
    public static void main(String[] args) {
        try {
            ...
            connection = DriverManager.getConnection("jdbc:sqlite:city.db");
...
//            String sql = "CREATE TABLE tb_CityCoding(name varchar(255),adcode varchar(255),citycode);"; // 插入交通状态信息
            String sql = "CREATE TABLE tb_city(id varchar(255),province varchar(255),city varchar(255),district varchar(255));";
